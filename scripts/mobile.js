  ...
  if (event.key === "Enter") {
    ...
    if (cityInputValue != "") {
      ...
      `;
          ...
          document.getElementById("locationName").innerHTML = "Không tìm thấy thành phố của bạn";
          document.getElementById("temperatureValue").innerHTML = "";
          document.getElementById("weatherType").innerHTML = "";
        }
      }
    ...
    else document.getElementById("locationName").innerHTML = "Nhập thành phố của bạn...";
  }
});